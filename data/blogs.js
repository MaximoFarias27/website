const blogs = [
    {
        ...
        contenido: [
            {
                clave: "p",
                contenido: "Cuando se trata de construir la casa de tus sueños, la superficie del terreno juega un papel crucial en la planificación y el diseño. En la arquitectura moderna, que busca adaptarse a las necesidades actuales de los residentes, tanto el tamaño como la disposición del terreno pueden influir significativamente en la funcionalidad y la calidad de vida que ofrecerá tu futura vivienda. En este artículo, exploraremos cómo la superficie del terreno afecta la construcción y qué debes considerar al elegir el lote ideal para tu proyecto."
            },
            {
                clave: "h2",
                contenido: "La importancia del tamaño del terreno"
            },
            {
                clave: "h3",
            ...
            {
                clave: "p",
                contenido: "Además, un fondo de terreno que no exceda los 25 metros asegura un equilibrio entre espacio útil y costos asociados. Esta disposición es favorable para quienes buscan una residencia que combine comodidad y eficiencia, sin comprometer el presupuesto."
            },
            {
                clave:"h3",
