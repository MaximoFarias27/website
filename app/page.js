  ...
  return (
    <div className="flex flex-col items-center">
      <div className="max-w-[1200px] w-[90%] flex flex-col items-center mb-20">
        ...
        <p className="w-full md:text-lg text-md mb-8">
        Elegir un profesional inmobiliario no es tarea sencilla. Realizar la compra venta de un bien inmueble es un hecho poco frecuente, esto puede generar, en algunos casos, desconcierto e incertidumbre. Transmitir confianza, transparencia y seguridad son valores fundamentales en nuestra profesión.
        </p>
        <p className="w-full md:text-lg text-md mb-8">
        Hay muchos aspectos al momento de trabajar una propiedad; colocar el cartel o subir la publicación en las redes, es el trabajo más simple. El conocimiento Jurídico y la capacidad de negociación son fundamentales para lograr el resultado deseado.
        </p>
        <p className="w-full md:text-lg text-md mb-8">
        Por otra parte, otro aspecto muy importante dentro de nuestra profesión, es la <b>Administración</b>. Y volvemos a lo simple, cobrar un alquiler mensual, emitir un recibo es tarea sencilla. Mantener el valor del Patrimonio de nuestros clientes con el paso del tiempo es nuestro compromiso. Y ahí está la clave. Desde la redacción del contrato, las garantías, la intermediación permanente llevando claridad a las partes ante dudas que generen conflictos de intereses, requiere de una profesionalidad, claridad en el conocimiento y dedicación. Por todo esto, a la hora de elegir una inmobiliaria no dudes en contactarnos. Contamos con un equipo de profesionales, que de forma inmediata se pondrán a tu disposición.        </p>
