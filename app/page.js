  ...
  return (
    <div className="flex flex-col items-center">
      <div className="max-w-[1200px] w-[90%] flex flex-col items-center mb-20">
        ...
        <div className="p-10 fondo-alquiler-zona w-full md:py-20 flex flex-col md:pl-20 rounded-lg items-center">
          <h3 className="md:w-full md:text-4xl text-xl font-semibold mb-8 text-white">Propiedades en alquiler</h3>
          ...
          <Link
            ...
            target="_blank"
            className="flex w-fit fondo-rojo text-white md:text-lg text-sm font-semibold py-2 px-4 rounded-lg gap-3 transition-all duration-300 hover:bg-red-900"
          >
        ...
        <div className="p-10 fondo-comprar-zona w-full md:py-20 rounded-lg my-10 flex md:justify-end md:pr-10 items-center">
          <div className=" flex flex-col md:w-2/4 md:items-end items-center">
            <h3 className="md:text-4xl text-xl md:text-right font-semibold mb-8 text-white md:w-full">Propiedades en Venta</h3>
        ...
        <div className="p-10 fondo-terrenos-venta w-full md:py-20 flex flex-col md:pl-20 rounded-lg items-center">
          <h3 className="md:w-full md:text-4xl text-xl font-semibold mb-8 text-white">Venta de Lotes y grandes parcelas</h3>
          <p className="md:w-2/4 md:text-lg text-sm mb-8 text-white">
