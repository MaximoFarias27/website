...
export const Footer = () => {
  return (
    <div className="fondo-rojo py-10 flex justify-center">
      <footer className="grid lg:grid-cols-3 grid-cols-1 max-w-[1200px] gap-y-10 md:max-w-full items-center">
        ...
        <div className="bg-white h-[2px] my-12 lg:my-4 lg:hidden block"></div>
