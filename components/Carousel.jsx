    ...
    <>
      ...
      <div className="carousel my-10 mx-auto overflow-hidden relative flex flex-col">
        ...
        <div className="md:absolute inset-0 flex flex-col justify-center items-center md:text-white py-10 md:p-10 md:bg-black md:bg-opacity-50 rounded-lg pt-16">
          ...
          <p className="w-full md:text-sm lg:text-lg text-md md:mb-4 lg:mb-8 md:text-center">
          Siempre estuvimos conscientes de lo que representa elegir una Inmobiliaria para realizar una operación. También que la gran mayoría de las personas realizan compra venta de bienes inmuebles, una o dos veces en toda su vida. Son muy pocos los que realizan operaciones con frecuencia. Esto genera sensaciones de desconcierto, desconfianza, e incertidumbre a la hora de elegir.
